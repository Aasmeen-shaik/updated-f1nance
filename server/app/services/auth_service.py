...
class AuthService:
    @staticmethod
    def register_user(db: Session, user_data: UserCreate, background_tasks: BackgroundTasks):
        try:
            ...
            background_tasks.add_task(EmailService.send_verification_email, user.email)
    ...
    @staticmethod
    def resend_verification_email(db: Session, user: User, background_tasks: BackgroundTasks):
