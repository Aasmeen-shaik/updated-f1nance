...
def register_user(
    ...
    """
    return AuthService.register_user(db=db, user_data=user_data, background_tasks=background_tasks)
...
def resend_verification(
    ...
    """
    return AuthService.resend_verification_email(db=db, user=current_user, background_tasks=background_tasks)
